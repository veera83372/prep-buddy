...
public class ColumnJoinerTest {
    ...
    public void shouldMargeTheGivenColumnsWithTheGivenSeperator() {
        ...
        ColumnJoiner columnJoiner = new ColumnJoiner(Arrays.asList(3, 1, 0), "_");
    ...
    public void shouldMargeTheGivenColumnsWithSpaceWhenNoSeperatorIsProvided() {
        ...
        ColumnJoiner columnJoiner = new ColumnJoiner(Arrays.asList(6, 2, 1));
        String[] actualValue = columnJoiner.apply(inputRecord);
    ...
    public void shouldMargeTheGivenColumnsAndPlaceTheResultAtCurrectPosition() {
        ...
        ColumnJoiner columnJoiner = new ColumnJoiner(Arrays.asList(4, 6, 1));
        String[] actualValue = columnJoiner.apply(inputRecord);
