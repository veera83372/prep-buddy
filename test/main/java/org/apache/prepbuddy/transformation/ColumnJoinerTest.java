...
public class ColumnJoinerTest {
    ...
    @Test
    public void shouldMargeTheGivenColumnsWithSpaceWhenNoSeperatorIsProvidedByReplacingTheCurrentValues() {
        String[] inputRecord = "FirstName,LastName,732,MiddleName,One,Two,Three".split(",");

        ColumnJoiner columnJoiner = new ColumnJoiner(Arrays.asList(6, 2, 1), false);
        String[] actualValue = columnJoiner.apply(inputRecord);
    ...
    @Test
    public void shouldMargeTheGivenColumnsAndPlaceTheResultAtCurrectPositionByReplacingTheCurrentValues() {
        String[] inputRecord = "FirstName,LastName,732,MiddleName,One,Two,Three".split(",");

        ColumnJoiner columnJoiner = new ColumnJoiner(Arrays.asList(4, 6, 1), false);
        String[] actualValue = columnJoiner.apply(inputRecord);
