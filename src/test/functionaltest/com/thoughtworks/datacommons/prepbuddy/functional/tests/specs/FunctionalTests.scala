package com.thoughtworks.datacommons.prepbuddy.functional.tests.specs

import com.thoughtworks.datacommons.prepbuddy.functional.tests.framework.FunctionalTest
import com.thoughtworks.datacommons.prepbuddy.qualityanalyzers.{DataType, MOBILE_NUMBER}
