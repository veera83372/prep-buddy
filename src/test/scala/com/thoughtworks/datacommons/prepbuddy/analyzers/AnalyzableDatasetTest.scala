...
import com.thoughtworks.datacommons.prepbuddy.analyzers.completeness.{EvaluationMode, RowCompletenessProfile, RowCompletenessRule}
...
class AnalyzableDatasetTest extends FunSuite {
    ...
    test("ROW_COMPLETENESS: should give percentage of row completeness when any column is null") {
        ...
        val completenessRule: RowCompletenessRule = new RowCompletenessRule(EvaluationMode.STRICT)
    ...
    test("ROW_COMPLETENESS: should give percentage of row completeness when specified columns is/are null") {
        ...
        val completenessRule: RowCompletenessRule = new RowCompletenessRule(EvaluationMode.CUSTOM, List("other"))
        val callRecordCompleteness: RowCompletenessProfile = callRecord.analyzeCompleteness(completenessRule)
