...
import org.datacommons.prepbuddy.clusterers.{ClusteringAlgorithm, TextFacets}
import org.datacommons.prepbuddy.imputations.ImputationStrategy
import org.datacommons.prepbuddy.normalizers.NormalizationStrategy
import org.datacommons.prepbuddy.rdds.TransformableRDD
import org.datacommons.prepbuddy.smoothers.SmoothingMethod
import org.datacommons.prepbuddy.types.{CSV, FileType}
import org.datacommons.prepbuddy.utils.PivotTable
...
class JavaTransformableRDD(rdd: JavaRDD[String], fileType: FileType) extends JavaRDD[String](rdd.rdd) {
    ...
    /**
      ...
      *
      * @param columnIndexes columnIndexes to be merged
      * @return JavaTransformableRDD
      */
